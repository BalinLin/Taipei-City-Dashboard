...
// 判斷是否有負數（僅在 series.length === 1 時成立）
const hasNegative = computed(() => {
	if (props.series.length !== 1) return false;
	return props.series[0].data.some((item) => item.y < 0);
});

// 取得正負最大最小值
const positiveMax = computed(() => {
	if (!hasNegative.value) return districtData.value.highest;
	return Math.max(0, ...props.series[0].data.map((item) => item.y));
});
const negativeMin = computed(() => {
	if (!hasNegative.value) return 0;
	return Math.min(0, ...props.series[0].data.map((item) => item.y));
});

// 動態產生每個區的顏色
function getDistrictColor(district) {
	if (!hasNegative.value) return props.chart_config.color[0];
	const val = districtData.value[district];
	if (val >= 0) return props.chart_config.color[0];
	return props.chart_config.color[1] || '#aaa';
}
// 動態產生每個區的 fill-opacity
function getDistrictOpacity(district) {
	const val = districtData.value[district];
	if (!hasNegative.value) {
		return Math.max(0.12, val / (districtData.value.highest || 1));
	}
	if (val >= 0) {
		return Math.max(0.12, val / (positiveMax.value || 1));
	} else {
		return Math.max(0.12, val / (negativeMin.value || -1));
	}
}
  ...
  >
    <div class="districtchart-title">
      ...
      <div class="districtchart-title-legend">
        ...
        <div
          v-if="hasNegative"
          :style="{ background: `linear-gradient(to right, ${props.chart_config.color[0]} 0%, ${props.chart_config.color[0]} 50%, ${props.chart_config.color[1]} 50%, ${props.chart_config.color[1] || '#aaa'} 100%)` }"
          class="hasNeg"
        />
        <div
          v-else
      ...
      >
        ...
        >
          <path
            ...
            :fill-opacity="getDistrictOpacity('新莊區')"
            :fill="getDistrictColor('新莊區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('淡水區')"
            :fill="getDistrictColor('淡水區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('汐止區')"
            :fill="getDistrictColor('汐止區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('板橋區')"
            :fill="getDistrictColor('板橋區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('三重區')"
            :fill="getDistrictColor('三重區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('樹林區')"
            :fill="getDistrictColor('樹林區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('土城區')"
            :fill="getDistrictColor('土城區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('蘆洲區')"
            :fill="getDistrictColor('蘆洲區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('中和區')"
            :fill="getDistrictColor('中和區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('永和區')"
            :fill="getDistrictColor('永和區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('新店區')"
            :fill="getDistrictColor('新店區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('鶯歌區')"
            :fill="getDistrictColor('鶯歌區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('三峽區')"
            :fill="getDistrictColor('三峽區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('瑞芳區')"
            :fill="getDistrictColor('瑞芳區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('五股區')"
            :fill="getDistrictColor('五股區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('泰山區')"
            :fill="getDistrictColor('泰山區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('林口區')"
            :fill="getDistrictColor('林口區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('深坑區')"
            :fill="getDistrictColor('深坑區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('石碇區')"
            :fill="getDistrictColor('石碇區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('坪林區')"
            :fill="getDistrictColor('坪林區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('三芝區')"
            :fill="getDistrictColor('三芝區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('石門區')"
            :fill="getDistrictColor('石門區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('八里區')"
            :fill="getDistrictColor('八里區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('平溪區')"
            :fill="getDistrictColor('平溪區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('雙溪區')"
            :fill="getDistrictColor('雙溪區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('貢寮區')"
            :fill="getDistrictColor('貢寮區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('金山區')"
            :fill="getDistrictColor('金山區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('萬里區')"
            :fill="getDistrictColor('萬里區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('烏來區')"
            :fill="getDistrictColor('烏來區')"
        ...
        >
          <path
            ...
            :fill-opacity="getDistrictOpacity('北投區')"
            :fill="getDistrictColor('北投區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('士林區')"
            :fill="getDistrictColor('士林區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('內湖區')"
            :fill="getDistrictColor('內湖區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('中山區')"
            :fill="getDistrictColor('中山區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('大同區')"
            :fill="getDistrictColor('大同區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('中正區')"
            :fill="getDistrictColor('中正區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('萬華區')"
            :fill="getDistrictColor('萬華區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('大安區')"
            :fill="getDistrictColor('大安區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('信義區')"
            :fill="getDistrictColor('信義區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('松山區')"
            :fill="getDistrictColor('松山區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('南港區')"
            :fill="getDistrictColor('南港區')"
          ...
          <path
            ...
            :fill-opacity="getDistrictOpacity('文山區')"
            :fill="getDistrictColor('文山區')"
		...
		&-legend {
			...
			div.hasNeg:before {
				...
				background: linear-gradient(
					to right,
					rgba(40, 42, 44, 0.2) 0%,
					rgba(40,42,44, 0.8) 50%,
					rgba(40,42,44, 0.8) 50%,
					rgba(40,42,44, 0.2) 100%)
			}
